...
th{background-color:#373737; color:#C0B283}
td,th{border:1px solid;padding:2px;vertical-align:top}
tr{background-color:#DCD0C0;border:1px solid;padding:2px;vertical-align:top}
